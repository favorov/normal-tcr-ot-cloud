...
6. `olga-p2b-p2b-mds-plot-samples-and-bc.py`
...
The scripts `olga-boxplot-samples-ot-2pb.py`, `olga-p2b-p2b-mds-plot-samples-and-bc.py`, and
...
- `olga-p2b-p2b-mds-plot-samples-and-bc.py`: 24 × 20 inches (was 12 × 10)
...
7. `olga-p2b-p2b-mds-plot-samples-and-bc.py`
...
**olga-p2b-p2b-mds-plot-samples-and-bc.py** — MDS visualization with barycenter:
