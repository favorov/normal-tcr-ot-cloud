...
python3 olga-p2b-ot.py input/samples Patient01.tsv --vdj-filter
```
...
python3 olga-p2b-ot.py input/samples Patient01.tsv --productive-filter --vdj-filter --vj-filter
```
