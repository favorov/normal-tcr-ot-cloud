...
load_distribution(filepath, freq_column="pgen", weights_column="duplicate_frequency_percent", productive_filter=False, vdj_filter=False)
...
5. Normalize: ensure weights sum to 1
6. Discretize onto common grid (for consistency)
7. Compute Wasserstein distance using EMD solver
