...
6. `olga-mds-plot-samples.py`
7. `olga-samples-p2b-pval.py`
8. `olga-simple-ot-mds-plot.py`
...
## Extended Information (Feb 18, 2026)

### New Script: olga-simple-ot-mds-plot.py

Simplified MDS visualization without barycenter requirement:
...
**Example usage:**
```bash
python3 olga-simple-ot-mds-plot.py input/samples-list.txt --output-plot mds.png
```
